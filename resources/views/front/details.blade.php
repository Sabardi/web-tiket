...
@section('content')
    <header class="relative h-[480px] mb-[44px]">
        <div id="Absolute-Top-Nav" class="absolute flex items-center justify-between w-full px-4 mt-[60px] z-10">
            <a href="{{ route('front.index') }}">
                <img src="{{ asset('front') }}/assets/images/icons/back.svg" class="w-12 h-12" alt="icon">
            </a>
            <a href="#">
                <img src="{{ asset('front') }}/assets/images/icons/heart.svg" class="w-12 h-12" alt="icon">
            </a>
        </div>
        <div id="Title" class="absolute bottom-0 w-full p-4 pt-0 z-10">
            <div
                ...
                <p class="w-fit flex shrink-0 items-center gap-[2px] rounded-full p-[6px_8px] bg-white">
                    <img src="{{ asset('front') }}/assets/images/icons/Star 1.svg" class="w-4 h-4" alt="star">
    ...
    <main id="details" class="flex flex-col gap-5 px-4 pb-[116px]">
        <section id="Get-to-Know" class="flex flex-col gap-[6px]">
            ...
            {{-- <p class="text-sm leading-[28px]">{{ strip_tags($ticket->about) }}</p> --}}
        ...
        <section id="Time" class="flex flex-col gap-[6px]">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                    <img src="{{ asset('front') }}/assets/images/icons/timer.svg" class="w-6 h-6" alt="icon">
                    <div class="text-left">
                ...
                <div class="flex items-center rounded-3xl p-[14px_16px] gap-4 bg-[#F8F8F9]">
                    <img src="{{ asset('front') }}/assets/images/icons/clock.svg" class="w-6 h-6" alt="icon">
                    <div class="text-left">
        ...
        <section id="Travel-with-Juara" class="flex flex-col gap-[6px]">
            ...
            <div class="grid grid-cols-3 gap-3">
                <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                    <img src="{{ asset('front') }}/assets/images/icons/security-card.svg" class="w-9 h-9" alt="icon">
                    <div>
                ...
                <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                    <img src="{{ asset('front') }}/assets/images/icons/hospital.svg" class="w-9 h-9" alt="icon">
                    <div>
                ...
                <div class="flex flex-col items-center rounded-3xl p-[14px_16px] gap-3 text-center bg-[#13181D]">
                    <img src="{{ asset('front') }}/assets/images/icons/lovely.svg" class="w-9 h-9" alt="icon">
                    <div>
        ...
        <section id="Management" class="flex flex-col gap-[6px]">
            ...
            <div class="flex items-center justify-between rounded-3xl p-[10px] pr-[14px] bg-[#F8F8F9]">
                ...
                <a href="#">
                    <img src="{{ asset('front') }}/assets/images/icons/call-orange.svg" class="w-10 h-10"
                        alt="">
                </a>
            </div>
        </section>
    ...
    <nav id="Bottom-Nav-Book"
        ...
        <a href="booking.html">
            <div class="flex items-center p-1 pl-5 w-fit gap-4 rounded-full bg-[#13181D]">
                ...
                <img src="{{ asset('front') }}/assets/images/icons/coupon.svg" class="w-[50px] h-[50px]" alt="icon">
            </div>
        </a>
    </nav>
@endsection
