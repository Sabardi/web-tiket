...
@section('content')
    ...
    <div id="Top-Nav" class="relative flex items-center justify-between w-full px-4 mt-[60px]">
        ...
        <img src="{{ asset('front') }}/assets/images/icons/Ellipse 3.svg"
    ...
    <main class="relative flex flex-col w-full gap-[30px] mt-[30px] overflow-x-hidden">
        <div class="flex flex-col gap-2 px-4">
            <div class="flex items-center gap-[6px]">
                <img src="{{Storage::url($category->icon)}}" class="w-[22px] h-[22px]"
                    alt="icon">
                    ...
                    <div class="flex items-center gap-[14px]">
                        ...
                        <div class="flex flex-col gap-[6px]">
                            ...
                            <div class="flex items-center gap-1">
                                <img src="{{ asset('front') }}/assets/images/icons/location.svg" class="w-[18px] h-[18px]"
                                    alt="icon">
                                <p class="font-semibold text-xs leading-[18px]">{{$ticket->address}}</p>
                            </div>
                            <p class="font-bold text-sm leading-[21px] text-[#F97316]">{{ formatRupiah($ticket->price)}}</p>
                        </div>
                    </div>
