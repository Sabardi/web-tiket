...
@section('content')
    <div id="Top-Nav" class="flex items-center justify-between w-full px-4 mt-[60px]">
        <a href="index.html">
            <img src="{{ asset('front') }}/assets/images/logos/logo.svg" class="flex shrink-0" alt="logo">
        </a>
        <a href="#">
            <img src="{{ asset('front') }}/assets/images/icons/heart-fill.svg" class="w-12 h-12" alt="icon">
        </a>
    </div>
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <p
                                            ...
                                            <img src="{{ asset('front') }}/assets/images/icons/Star 1.svg" class="w-4 h-4"
                                                alt="star">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-[14px]">
                                <div class="flex w-[90px] h-[90px] shrink-0 rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ Storage::url($newTicket->thumbnail) }}" class="w-full h-full object-cover"
                                        alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-[6px]">
                                    <h3 class="font-semibold">{{ $newTicket->name }}</h3>
                                    <div class="flex items-center gap-1">
                                        <img src="{{ asset('front') }}/assets/images/icons/location.svg"
